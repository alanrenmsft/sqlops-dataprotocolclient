...
class AgentServicesFeature extends SqlOpsFeature {
    constructor(client) {
    ...
    registerProvider(options) {
        ...
        let getJobs = (ownerUri) => {
            ...
            return client.sendRequest(protocol.AgentJobsRequest.type, params).then(r => r, e => {
        ...
        let getJobHistory = (connectionUri, jobID) => {
            ...
            return client.sendRequest(protocol.AgentJobHistoryRequest.type, params).then(r => r, e => {
        ...
        let jobAction = (connectionUri, jobName, action) => {
            ...
            return client.sendRequest(protocol.AgentJobActionRequest.type, params).then(r => r, e => {

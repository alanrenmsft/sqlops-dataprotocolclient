...
export declare namespace AgentJobsRequest {
    const type: RequestType<types.AgentJobsParams, types.AgentJobsResult, void, void>;
}
export declare namespace AgentJobHistoryRequest {
    const type: RequestType<types.AgentJobHistoryParams, types.AgentJobHistoryResult, void, void>;
}
export declare namespace AgentJobActionRequest {
    const type: RequestType<types.AgentJobActionParams, types.AgentJobActionResult, void, void>;
}
